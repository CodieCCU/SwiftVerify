      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, color: '#333', lineHeight: '1.5' }}>
            <strong>SwiftVerify does NOT store Social Security Numbers (SSNs)</strong> in any form—not in 
            plaintext, encrypted, hashed, or any equivalent form. All verification data is processed 
